...
enum EPxRTSPState
{
	...
	kePxRTSPState_CLOSED,
	kePxRTSPState_OPTIONS,
	kePxRTSPState_DESCRIBE,
	kePxRTSPState_SETUP,
	kePxRTSPState_PLAY,
	kePxRTSPState_TEARDOWN
};
...
public:
	EPxRTSPState m_eRTSPState;
	Boolean      streamUsingTCP;

	char szRTSPProcessInfoFileName[1024]; // 用于保存交互过程的信息
	bool bRTSPProcessInfo2File;
